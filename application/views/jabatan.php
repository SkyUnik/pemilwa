<div class="container">
  <div class="container">
    ...
    <table class="table table-hover table-striped">
      ...
      <td class='col-sm-1'>", $jbtn->kode_kls, "</td>
      <td class='col-sm-3'>", $jbtn->kls, "</td>
      <td>
    ...
    <div class="row">
      <div class="col-xs-6">
        <button class="btn btn-default" type="button" data-toggle="collapse" data-target="#collapseExample"
          aria-expanded="false" aria-controls="collapseExample"> Tambah Jabatan Baru </button>
        <div class="collapse" id="collapseExample">
          <div class="well">
            ...
            <?php echo form_input($kode_kls); ?>
            <?php echo form_input($kls); ?>
            <br>
