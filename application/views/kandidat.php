<div class="container">
  <div class="container">
    ...
    <table class="table table-hover table-striped">
      ...
      <tbody>
        ...
        foreach ($data_kandidat as $kandidat) {
          ...
          $data_jabatan = $this->db->select(array('jabatan', 'kls'))->get_where('jabatan', array('id' => $kandidat->jabatan))->row();

          echo "<tr>  
      <td><img src='" . base_url('asset/upload/img/' . $kandidat->pict) . "' style='height: 50px'></td>
      <td class='col-lg-1'>", $kandidat->no_urut, "</td>
      <td>", $nama, "</td>
      <td><b>" . $data_jabatan->jabatan . "</b> kelas <b>" . $data_jabatan->kls . "</b></td>
      <td>";
          if ($role == '1') {
    ...
    <?php else: ?>
      <div class="row">
        <div class="col-12">
          <a href="<?php echo base_url('kandidat/tambah_kandidat') ?>" title="" class="btn btn-default">Tambah
            Kandidat</a>
