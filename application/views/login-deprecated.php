<div class="container text-center">
    <div>
        <h1>Selamat Datang di Pemilihan Ketua OSIS SMAN
            2 KUNINGAN</h1>
    </div>
    <?php
 ...
 <g id="Layer_x0020_1">
  ...
  <rect class="fil1" transform="matrix(4.64241 -0 -1.02442 1 348.355 0)" width="6.66891" height="157.924"/>
    ...
    echo '<p class="lead"> Login </p> <svg class="img-responsive center-block" xmlns="http://www.w3.org/2000/svg" xml:space="preserve" width="400px" height="198px" version="1.1" style="shape-rendering:geometricPrecision; text-rendering:geometricPrecision; image-rendering:optimizeQuality; fill-rule:evenodd; clip-rule:evenodd" viewBox="0 0 368 183" xmlns:xlink="http://www.w3.org/1999/xlink">
           <defs>
            <style type="text/css">
             <![CDATA[
              .fil1 {fill:black}
