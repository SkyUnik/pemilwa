    ...
    <div class="container">
        ...
        <div class="dropdown pull-right">
            <button class="btn btn-default dropdown-toggle" type="button" data-toggle="dropdown"><img
                    src="<?php echo base_url('asset/img/user.svg') ?>" alt="ikon verifikasi"
                    width="15px"><?php echo " $cek" ?>
    ...
    <div class="col-sm-3">
        <div class="panel panel-success">
            ...
            <div class="panel-heading text-center">
                <?php if ($role == '2'): ?>
                <a class="btn btn-default disabled"><img src="<?php echo base_url('asset/img/block.png') ?>"
                        width="10px"></a>
    ...
    <div class="col-sm-3">
        <div class="panel panel-warning">
            ...
            <div class="panel-heading text-center">
                ...
                <?php else: ?>
                <a href="<?php echo base_url('admin/verifikasi') ?>" title="" class="btn btn-default">Verifikasi
                    Pemilih</a>
                <?php endif ?>
                </a>
            </div>
